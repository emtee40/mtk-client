...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.readFlashMenu.addAction(self.actionRead_preloader)
        self.readFlashMenu.addAction(self.actionRead_boot2)
        ...
        self.writeFlashMenu.addAction(self.actionWrite_preloader)
        self.writeFlashMenu.addAction(self.actionWrite_boot2)
